...
<html lang="en">
    <head>
        ...
        <!-- description -->
        <meta name="description" content="App landing Page is a highly creative, modern, visually stunning and Bootstrap responsive multipurpose agency and HTML5 template with 14 ready home page demos.">
        <!-- keywords -->
        ...
        <!-- Page Title -->
        <title>File Manager - Manage your Files easily.</title>
        <!-- Favicon -->
    ...
    <header class="head-sec">
            ...
            <nav class="navbar navbar-expand-lg nav-up">
                ...
                <div class="collapse navbar-collapse d-none d-lg-block" id="navbarNav">
                    <ul class="navbar-nav horizontal-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link scroll" href="#banner-sec">Home</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link scroll" href="#get-app-sec">Download</a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="broad">
            ...
            <nav class="navbar navbar-light">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link scroll" href="#banner-sec"><i class="las la-angle-double-right"></i> Home</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link scroll" href="#get-app-sec"><i class="las la-angle-double-right"></i> Download</a>
                    </li>
                </ul>
            </nav>
        </div>
    ...
    <!--Screen content end-->
    <section class="app-clips" id="app-clips" style="background-color: #fdd8a4;border-bottom-right-radius: 27%;">
        <div class="container">
            <div class="row">
    ...
    <section id="get-app-sec" class="get-app-sec" style="background: url('./img/banner2.jpg');">
